...
const MENU_ITEMS = {
  Coffee: [
    { title: 'Espresso', price: 3.50, desc: 'Bold and rich espresso shot', tags: ['vegan', 'gluten-free', 'dairy-free'] },
    { title: 'Cappuccino', price: 4.50, desc: 'Espresso with steamed milk and foam', tags: ['vegetarian'] },
    { title: 'Latte', price: 4.75, desc: 'Smooth espresso with steamed milk', tags: ['vegetarian'] },
    { title: 'Cold Brew', price: 4.00, desc: 'Smooth cold-brewed coffee', tags: ['vegan', 'gluten-free', 'dairy-free'] },
    { title: 'Americano', price: 3.75, desc: 'Espresso with hot water', tags: ['vegan', 'gluten-free', 'dairy-free'] },
  ],
  Espresso: [
    { title: 'Double Shot', price: 4.00, desc: 'Two shots of espresso', tags: ['vegan', 'gluten-free', 'dairy-free'] },
    { title: 'Macchiato', price: 4.25, desc: 'Espresso with foam', tags: ['vegetarian'] },
    { title: 'Cortado', price: 4.50, desc: 'Espresso with equal parts steamed milk', tags: ['vegetarian'] },
  ],
  Pastries: [
    { title: 'Croissant', price: 3.50, desc: 'Buttery flaky croissant', tags: ['vegetarian'], allergens: ['wheat', 'dairy'] },
    { title: 'Muffin', price: 3.00, desc: 'Fresh baked muffin', tags: ['vegetarian'], allergens: ['wheat', 'eggs', 'dairy'] },
    { title: 'Danish', price: 3.75, desc: 'Sweet pastry with fruit', tags: ['vegetarian'], allergens: ['wheat', 'dairy', 'eggs'] },
  ],
  Breakfast: [
    { title: 'Breakfast Sandwich', price: 6.50, desc: 'Egg, cheese, and choice of meat', allergens: ['wheat', 'dairy', 'eggs'] },
    { title: 'Avocado Toast', price: 7.50, desc: 'Smashed avocado on artisan bread', tags: ['vegan'], allergens: ['wheat'] },
    { title: 'Breakfast Burrito', price: 7.00, desc: 'Eggs, cheese, and salsa wrapped in tortilla', tags: ['vegetarian'], allergens: ['wheat', 'dairy', 'eggs'] },
  ],
  Pizza: [
    { title: 'Margherita', price: 12.99, desc: 'Fresh mozzarella, basil, tomato sauce', tags: ['vegetarian'], allergens: ['wheat', 'dairy'] },
    { title: 'Pepperoni', price: 14.99, desc: 'Classic pepperoni pizza', allergens: ['wheat', 'dairy'] },
    { title: 'Veggie Supreme', price: 13.99, desc: 'Loaded with fresh vegetables', tags: ['vegetarian'], allergens: ['wheat', 'dairy'] },
    { title: 'Meat Lovers', price: 16.99, desc: 'Pepperoni, sausage, bacon, ham', allergens: ['wheat', 'dairy'] },
    { title: 'BBQ Chicken', price: 15.99, desc: 'BBQ sauce, chicken, red onions', allergens: ['wheat', 'dairy'] },
  ],
  Pasta: [
    { title: 'Spaghetti Carbonara', price: 13.99, desc: 'Creamy pasta with bacon', allergens: ['wheat', 'dairy', 'eggs'] },
    { title: 'Penne Arrabiata', price: 12.99, desc: 'Spicy tomato sauce', tags: ['vegan'], spicyLevel: 2, allergens: ['wheat'] },
    { title: 'Fettuccine Alfredo', price: 13.50, desc: 'Creamy alfredo sauce', tags: ['vegetarian'], allergens: ['wheat', 'dairy'] },
  ],
  Salads: [
    { title: 'Caesar Salad', price: 8.99, desc: 'Romaine, parmesan, croutons', tags: ['vegetarian'], allergens: ['wheat', 'dairy', 'eggs'] },
    { title: 'Greek Salad', price: 9.50, desc: 'Feta, olives, tomatoes, cucumber', tags: ['vegetarian', 'gluten-free'], allergens: ['dairy'] },
  ],
  Appetizers: [
    { title: 'Garlic Bread', price: 5.99, desc: 'Fresh baked garlic bread', tags: ['vegetarian'], allergens: ['wheat', 'dairy'] },
    { title: 'Mozzarella Sticks', price: 6.99, desc: 'Fried mozzarella with marinara', tags: ['vegetarian'], allergens: ['wheat', 'dairy'] },
    { title: 'Wings', price: 9.99, desc: 'Buffalo or BBQ wings', allergens: [] },
  ],
  Burgers: [
    { title: 'Classic Burger', price: 9.99, desc: 'Beef patty, lettuce, tomato, pickles', allergens: ['wheat'] },
    { title: 'Cheeseburger', price: 10.99, desc: 'Classic with American cheese', allergens: ['wheat', 'dairy'] },
    { title: 'Bacon Burger', price: 11.99, desc: 'Bacon, cheese, BBQ sauce', allergens: ['wheat', 'dairy'] },
    { title: 'Mushroom Swiss', price: 11.50, desc: 'Sautéed mushrooms, Swiss cheese', allergens: ['wheat', 'dairy'] },
    { title: 'Veggie Burger', price: 10.50, desc: 'Plant-based patty', tags: ['vegan', 'vegetarian'], allergens: ['wheat'] },
  ],
  Fries: [
    { title: 'Regular Fries', price: 3.99, desc: 'Crispy golden fries', tags: ['vegan', 'gluten-free', 'dairy-free'], allergens: [] },
    { title: 'Sweet Potato Fries', price: 4.99, desc: 'Sweet potato fries', tags: ['vegan', 'gluten-free', 'dairy-free'], allergens: [] },
    { title: 'Loaded Fries', price: 6.99, desc: 'Cheese, bacon, sour cream', allergens: ['dairy'] },
  ],
  Shakes: [
    { title: 'Vanilla Shake', price: 4.99, desc: 'Classic vanilla milkshake', tags: ['vegetarian'], allergens: ['dairy'] },
    { title: 'Chocolate Shake', price: 4.99, desc: 'Rich chocolate milkshake', tags: ['vegetarian'], allergens: ['dairy'] },
    { title: 'Strawberry Shake', price: 4.99, desc: 'Fresh strawberry shake', tags: ['vegetarian'], allergens: ['dairy'] },
  ],
  Sides: [
    { title: 'Onion Rings', price: 4.99, desc: 'Beer-battered onion rings', tags: ['vegetarian'], allergens: ['wheat'] },
    { title: 'Coleslaw', price: 2.99, desc: 'Creamy coleslaw', tags: ['vegetarian'], allergens: ['dairy', 'eggs'] },
    { title: 'Mac & Cheese', price: 4.50, desc: 'Creamy mac and cheese', tags: ['vegetarian'], allergens: ['wheat', 'dairy'] },
  ],
  Rolls: [
    { title: 'California Roll', price: 8.99, desc: 'Crab, avocado, cucumber', allergens: ['fish', 'shellfish'] },
    { title: 'Spicy Tuna Roll', price: 9.99, desc: 'Spicy tuna with cucumber', allergens: ['fish', 'shellfish'] },
    { title: 'Dragon Roll', price: 14.99, desc: 'Shrimp tempura, eel, avocado', allergens: ['fish', 'shellfish'] },
    { title: 'Rainbow Roll', price: 15.99, desc: 'Assorted fish over California roll', allergens: ['fish', 'shellfish'] },
    { title: 'Philadelphia Roll', price: 9.50, desc: 'Salmon, cream cheese, cucumber', allergens: ['fish', 'dairy', 'shellfish'] },
  ],
  Sashimi: [
    { title: 'Salmon Sashimi', price: 12.99, desc: '6 pieces of fresh salmon', tags: ['vegan', 'gluten-free', 'dairy-free'], allergens: ['fish'] },
    { title: 'Tuna Sashimi', price: 13.99, desc: '6 pieces of fresh tuna', tags: ['vegan', 'gluten-free', 'dairy-free'], allergens: ['fish'] },
    { title: 'Yellowtail Sashimi', price: 14.99, desc: '6 pieces of yellowtail', tags: ['vegan', 'gluten-free', 'dairy-free'], allergens: ['fish'] },
  ],
  Nigiri: [
    { title: 'Salmon Nigiri', price: 5.99, desc: '2 pieces of salmon nigiri', tags: ['vegan', 'gluten-free', 'dairy-free'], allergens: ['fish'] },
    { title: 'Tuna Nigiri', price: 6.50, desc: '2 pieces of tuna nigiri', tags: ['vegan', 'gluten-free', 'dairy-free'], allergens: ['fish'] },
    { title: 'Eel Nigiri', price: 6.99, desc: '2 pieces of eel nigiri', allergens: ['fish'] },
  ],
  Tacos: [
    { title: 'Carnitas Taco', price: 3.50, desc: 'Slow-cooked pork', tags: ['gluten-free'], allergens: [] },
    { title: 'Carne Asada Taco', price: 3.75, desc: 'Grilled steak', tags: ['gluten-free'], allergens: [] },
    { title: 'Chicken Taco', price: 3.25, desc: 'Seasoned grilled chicken', tags: ['gluten-free'], allergens: [] },
    { title: 'Fish Taco', price: 4.50, desc: 'Beer-battered fish', allergens: ['wheat', 'fish'] },
    { title: 'Veggie Taco', price: 3.00, desc: 'Grilled vegetables', tags: ['vegan', 'gluten-free'], allergens: [] },
  ],
  Burritos: [
    { title: 'Bean & Cheese Burrito', price: 6.50, desc: 'Refried beans and cheese', tags: ['vegetarian'], allergens: ['wheat', 'dairy'] },
    { title: 'Carnitas Burrito', price: 8.99, desc: 'Pork, rice, beans', tags: ['gluten-free'], allergens: [] },
    { title: 'Steak Burrito', price: 9.99, desc: 'Steak, rice, beans, salsa', tags: ['gluten-free'], allergens: [] },
  ],
  Quesadillas: [
    { title: 'Cheese Quesadilla', price: 5.99, desc: 'Melted cheese in tortilla', tags: ['vegetarian'], allergens: ['wheat', 'dairy'] },
    { title: 'Chicken Quesadilla', price: 7.99, desc: 'Chicken and cheese', tags: ['gluten-free'], allergens: ['dairy'] },
    { title: 'Steak Quesadilla', price: 8.99, desc: 'Steak and cheese', tags: ['gluten-free'], allergens: ['dairy'] },
  ],
  Curry: [
    { title: 'Green Curry', price: 11.99, desc: 'Coconut curry with vegetables', tags: ['vegan', 'gluten-free'], spicyLevel: 3, allergens: [] },
    { title: 'Red Curry', price: 11.99, desc: 'Spicy red curry', tags: ['vegan', 'gluten-free'], spicyLevel: 4, allergens: [] },
    { title: 'Massaman Curry', price: 12.99, desc: 'Mild curry with peanuts', tags: ['gluten-free'], spicyLevel: 1, allergens: ['peanuts'] },
  ],
  Noodles: [
    { title: 'Pad Thai', price: 10.99, desc: 'Stir-fried rice noodles', spicyLevel: 2, allergens: ['wheat', 'peanuts', 'shellfish'] },
    { title: 'Drunken Noodles', price: 11.50, desc: 'Spicy basil noodles', spicyLevel: 4, allergens: ['wheat', 'shellfish'] },
    { title: 'Pad See Ew', price: 10.99, desc: 'Sweet soy noodles', spicyLevel: 1, allergens: ['wheat', 'shellfish'] },
  ],
  'Rice Dishes': [
    { title: 'Fried Rice', price: 9.99, desc: 'Thai-style fried rice', tags: ['vegan', 'gluten-free', 'dairy-free'], allergens: [] },
    { title: 'Basil Fried Rice', price: 10.50, desc: 'Spicy basil fried rice', tags: ['vegan', 'gluten-free', 'dairy-free'], spicyLevel: 2, allergens: [] },
  ],
  Brisket: [
    { title: 'Sliced Brisket', price: 14.99, desc: 'Tender smoked brisket', unit: 'lb', tags: ['gluten-free', 'dairy-free'], allergens: [] },
    { title: 'Chopped Brisket', price: 13.99, desc: 'Chopped smoked brisket', unit: 'lb', tags: ['gluten-free', 'dairy-free'], allergens: [] },
  ],
  Ribs: [
    { title: 'Beef Ribs', price: 16.99, desc: 'Slow-smoked beef ribs', unit: 'lb', tags: ['gluten-free', 'dairy-free'], allergens: [] },
    { title: 'Pork Ribs', price: 14.99, desc: 'Fall-off-the-bone ribs', unit: 'lb', tags: ['gluten-free', 'dairy-free'], allergens: [] },
  ],
  Sandwiches: [
    { title: 'Brisket Sandwich', price: 9.99, desc: 'Sliced brisket on Texas toast', allergens: ['wheat', 'dairy'] },
    { title: 'Pulled Pork Sandwich', price: 8.99, desc: 'Pulled pork with coleslaw', allergens: ['wheat', 'dairy', 'eggs'] },
  ],
  Bread: [
    { title: 'Sourdough Loaf', price: 6.99, desc: 'Fresh sourdough bread', tags: ['vegan', 'vegetarian'], allergens: ['wheat'] },
    { title: 'Baguette', price: 4.99, desc: 'French baguette', tags: ['vegan', 'vegetarian'], allergens: ['wheat'] },
    { title: 'Ciabatta', price: 5.50, desc: 'Italian ciabatta', tags: ['vegan', 'vegetarian'], allergens: ['wheat'] },
  ],
  Cakes: [
    { title: 'Chocolate Cake', price: 4.99, desc: 'Rich chocolate cake slice', tags: ['vegetarian'], allergens: ['wheat', 'dairy', 'eggs'] },
    { title: 'Carrot Cake', price: 4.50, desc: 'Moist carrot cake with cream cheese frosting', tags: ['vegetarian'], allergens: ['wheat', 'dairy', 'eggs', 'nuts'] },
    { title: 'Red Velvet', price: 5.50, desc: 'Classic red velvet cake', tags: ['vegetarian'], allergens: ['wheat', 'dairy', 'eggs'] },
  ],
  Cookies: [
    { title: 'Chocolate Chip Cookie', price: 2.50, desc: 'Classic chocolate chip', tags: ['vegetarian'], allergens: ['wheat', 'dairy', 'eggs'] },
    { title: 'Oatmeal Cookie', price: 2.25, desc: 'Oatmeal raisin cookie', tags: ['vegetarian'], allergens: ['wheat', 'dairy', 'eggs'] },
    { title: 'Sugar Cookie', price: 2.00, desc: 'Soft sugar cookie', tags: ['vegetarian'], allergens: ['wheat', 'dairy', 'eggs'] },
  ],
}
