...
-- This table stores location updates from all delivery providers
...
CREATE INDEX idx_delivery_tracking_points_job ON delivery_tracking_points(delivery_job_id);
