...
export async function getStoreAffiliateSalesSummary(storeId) {
...
export async function getStoreAffiliateSalesByAffiliate(storeId) {
    const rows = await prisma.$queryRaw(Prisma.sql `
    SELECT
      a.id AS affiliateId,
...
export async function getStoreAffiliateRecentOrders(storeId, limit = 25) {
